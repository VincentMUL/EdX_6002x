...
def fitData1(fileName):
    ...
    pylab.plot(xVals, estYVals, label = 'Linear fit' + ', R² = ' + str(round(error, 5)))
    a,b,c,d = pylab.polyfit(xVals, yVals, 3)
    estYVals = a*(xVals**3) + b*xVals**2 + c*xVals + d
    pylab.plot(xVals, estYVals, label = 'Cubic fit' + ', R² = ' + str(round(error, 5)))
    pylab.legend(loc = 'best')
...
def fitData3(fileName):
    ...
    error = rSquare(yVals, estYVals)
    pylab.plot(xVals, estYVals, label = 'Linear fit, k = '
               + str(round(k, 5))+ ', R² = ' + str(round(error, 5)))
    pylab.legend(loc = 'best')
