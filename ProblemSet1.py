...
# change function/method names, or delete provided docstrings.
# You will need to keep ps1_partition.py and ps1_cow_data.txt in the same folder as ps1.py.
...
# All of your code for Part A should go into ps1.py.
# First we need to load the cow data from the data file ps1_cow_data.txt, 
# this has already been done for you and should let you begin working on the rest of this problem. 
...
# You can expect the data to be formatted in pairs of x,y on each line, 
# where x is the name of the cow and y is a number indicating how much the cow weighs in tons, 
